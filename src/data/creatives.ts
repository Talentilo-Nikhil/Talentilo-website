...
export const creatives = {
  ...
  "mg-card-bullhorn": {
    ...
    "designWidth": 560,
    "designHeight": 430,
    "alt": "A Bullhorn migration mapping a static database and paid plugins onto the Talentilo engine, with a decade of relationship data intact"
  },
  "mg-card-zoho": {
    ...
    "designWidth": 560,
    "designHeight": 430,
    "alt": "A Zoho Recruit migration lifting Small Biz limits and manual workarounds to enterprise scale without losing operational simplicity"
  },
  "ti-boolean-legacy": {
